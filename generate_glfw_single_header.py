...
headers = list([
    "cocoa_joystick.h", "linux_joystick.h", "null_joystick.h", "win32_joystick.h",
    "cocoa_platform.h", "null_platform.h", "win32_platform.h", "wl_platform.h", "x11_platform.h",
    "egl_context.h", "glx_context.h", "nsgl_context.h", "wgl_context.h", "osmesa_context.h",
    "mappings.h",
    "posix_thread.h",
    "posix_time.h",
    "xkb_unicode.h",
...
headers_result  = "/* generated with https://github.com/SasLuca/glfw-single-header */\n"
headers_result += "/* Define _GLFW_IMPLEMENTATION to unroll the implementation into a single compilation unit. */\n"
headers_result += "/* Also, before including <glfw.h> do define one of these: */\n"
headers_result += "/* _GLFW_COCOA */\n"
headers_result += "/* _GLFW_WIN32 */\n"
headers_result += "/* _GLFW_X11 */\n"
headers_result += "/* _GLFW_WAYLAND */\n"
headers_result += "/* _GLFW_OSMESA */\n\n\n"
